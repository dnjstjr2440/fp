			...
			<input type="hidden" name="category" value="insertChk">
				<div class="insertBox5_yj">
					...
					<div class="insertBox3_yj">
						<input type="text" placeholder="이름" name="mem_name"></input>
					</div>
					<div class="insertBox3_yj">
						<input type="text" placeholder="아이디" name="mem_id"></input><input type="button"
							value="중복확인"></input>
					</div>
					<div class="insertBox3_yj">
						<input type="password" placeholder="비밀번호" name="mem_pwd"></input>
					</div>
					...
					<div class="insertBox3_yj">
						...
						<input type="text"	style="width: 300px;" name="mem_phone"/>
					</div>
					<div class="insertBox3_yj">
						<input type="text" style="width: 300px;" name="mem_addr"/>
					</div>
					<div class="insertBox3_yj">
						<input type="text" style="width: 300px;" name="mem_email"/>
